...
def csv2trie(inName, root):
    ...
    outFile = open("Tweets.csv", 'a', encoding="utf8")
    ...
    with open(inName, 'r', encoding="utf8") as inFile:
        ...
        for i, line in enumerate(inFile):
            ...
            for word in tweet.text.split():
                insertTrie(root, Word(word,tweet.value), i)
...
def AdicionaNovoArq(novoArq, MainArq, root):
    with open(MainArq, 'a', encoding="utf8") as Arq:
        with open(novoArq, 'r', encoding="utf8") as Arq2:
            root = csv2trie(novoArq, root)
